...
class StreamWrapper {
	 ...
	 * 
	 * @throws StreamWrapperRegisterException if the stream wrapper is already registered.
	 */
	 ...
	 * 
	 * @throws StreamWrapperRegisterException if the stream wrapper isn't registered.
	 */
	 ...
	 * @throws UnsupportedAccessModeException if the given mode isn't supported.
	 * @throws MissingCacheContainerException if no cache container is set for the given path.
	 */
	 ...
	 * @return The number of bytes that were successfully stored, or 0 if none could be stored.
	 */
