...
class Lexer {
	 ...
	 * @param \com\mohiva\elixir\document\expression\Lexer $expressionLexer The expression lexer object to 
	 ...
	 * not work.
	 * 
	 * @param \com\mohiva\common\xml\XMLDocument $doc The XML document to tokenize.
	 ...
	 * 
	 * @param \com\mohiva\common\xml\XMLDocument $doc The document to tokenize.
	 */
	private function tokenize(XMLDocument $doc) {
		...
		for ($i = $nodes->length - 1; $i >= 0; $i--) {
			/* @var \com\mohiva\common\xml\XMLElement $node */
			$node = $nodes->item($i);
	 ...
	 * 
	 * @param \com\mohiva\common\xml\XMLElement $element The current processed XML element object.
	 */
	 ...
	 * it to the stream.
	 * 
	 * @param \com\mohiva\common\xml\XMLElement $element The current processed element.
	...
	private function getChildNodesAsContent(XMLElement $element) {
		...
		foreach ($element->childNodes as $child) {
			/* @var \com\mohiva\common\xml\XMLElement $child */
	 ...
	 * 
	 * @param \com\mohiva\common\xml\XMLElement $element The current processed node.
	 */
